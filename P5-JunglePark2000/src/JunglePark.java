...
/**
 * Creates a new park, with Tigers and Deer where they interact with each other. The Deer create 
 * Treat detected messages when a Tiger is near, and a Tiger will eat a Deer if one is near. 
 * Also has buttons to add and remove both Tigers and Deer. 
 * 
 * @author Mouna Kacem
 *
 */
